...
feature1 = generateFeature(c2_accel_x,p2_accel_x,t2_accel_x,cw1_accel_x,o2_accel_x,idle2_accel_x, 50,600,'std Accel X axis','std');

feature2 = generateFeature(c2_accel_y,p2_accel_y,t2_accel_y,cw1_accel_y,o2_accel_y,idle2_accel_y, 50,600,'std Accel Y axis','std'); 

feature3 = generateFeature(c2_accel_z,p2_accel_z,t2_accel_z,cw1_accel_z,o2_accel_z, idle2_accel_z, 50,600,'std Accel Z axis','std');

feature4 = generateFeature(c2_gyro_x,p2_gyro_x,t2_gyro_x,cw1_gyro_x,o2_gyro_x,idle2_gyro_x, 50,600,'std Gyroscope X axis','std');

feature5 = generateFeature(c2_gyro_y,p2_gyro_y,t2_gyro_y,cw1_gyro_y,o2_gyro_y, idle2_gyro_y, 50,600,'std Gyroscope Y axis','std');

feature6 = generateFeature(c2_gyro_z,p2_gyro_z,t2_gyro_z,cw1_gyro_z,o2_gyro_z, idle2_gyro_z, 50,600,'std Gyroscope Z axis','std');

feature7 = generateFeature(c2_accel_x,p2_accel_x,t2_accel_x,cw1_accel_x,o2_accel_x, idle2_accel_x, 50,600,'var Accel X axis','var');

feature8 = generateFeature(c2_accel_y,p2_accel_y,t2_accel_y,cw1_accel_y,o2_accel_y, idle2_accel_y, 50,600,'var Accel Y axis','var'); 

feature9 = generateFeature(c2_accel_z,p2_accel_z,t2_accel_z,cw1_accel_z,o2_accel_z, idle2_accel_z, 50,600,'var Accel Z axis','var');

feature10 = generateFeature(c2_gyro_x,p2_gyro_x,t2_gyro_x,cw1_gyro_x,o2_gyro_x, idle2_gyro_x ,50,600,'var Gyroscope X axis','var');

feature11 = generateFeature(c2_gyro_y,p2_gyro_y,t2_gyro_y,cw1_gyro_y,o2_gyro_y, idle2_gyro_y ,50,600,'var Gyroscope Y axis','var');

feature12 = generateFeature(c2_gyro_z,p2_gyro_z,t2_gyro_z,cw1_gyro_z,o2_gyro_z,idle2_gyro_z,50,600 ,'var Gyroscope Z axis','var');
...
target_matrix((4*gesture_size)+1:(5*gesture_size),:)=zeros(gesture_size,1);

target_matrix((5*gesture_size)+1:(6*gesture_size),:)=ones(gesture_size,1);
